  ...
  )
{
  ...
  CpmemWord0PackedReg.HorizontalFlip = FeaturePcdGet(PcdGopHorizontalFlip) ? CPMEM_HF_HFLIP_ENABLE : CPMEM_HF_NO_HFLIP;
  CpmemWord0PackedReg.VerticalFlip = FeaturePcdGet(PcdGopVerticalFlip) ? CPMEM_HF_VFLIP_ENABLE : CPMEM_HF_NO_VFLIP;
