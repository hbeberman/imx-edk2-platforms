...
/**
  Send a request string to the provisioning host and recieve a response buffer.
...
/**
  ...
  Notify the provisioning host to recieve the ekcert by sending MFG:ekcert.
...
/**
  Recieve a cross-signed device certificate from the provisioning host.
...
/**
  Recieve a SMBIOS values from the provisioning host.
...
/**
  ...
  2) Stall for 5 seconds then exit if theres no provisioning host.
  3) Send the EK Certificate to a provisioning host.
  4) Recieve a device certificate from the provisioning host.
  5) Recieve a SMBIOS values from the provisioning host.
